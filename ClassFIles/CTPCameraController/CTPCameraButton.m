...
@implementation CTPCameraButton
...
{
    // 设置camera view
    CTPCameraButton *cameraButton = [[CTPCameraButton alloc] initWithFrame:CGRectMake(0, 0, CAMERABUTTONWIDTH, CAMERABUTTONWIDTH)];
